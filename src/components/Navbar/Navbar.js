        ...
        <header>
            ...
            <Container style={menu}>
                ...
                <Nav className="justify-content-end flex-grow-1 pe-3">
                    <Nav.Link> <NavLink to ="/" style={link}> Inicio </NavLink></Nav.Link>
                    ...
                    <NavDropdown title="Intensidades" id="basic-nav-dropdown" style={link}>
                        <NavDropdown.Item ><NavLink to ="/Category/1" style={link}> Suave </NavLink></NavDropdown.Item>
                        <NavDropdown.Item ><NavLink to ="/Category/2" style={link}> Fuerte </NavLink></NavDropdown.Item>
                    </NavDropdown>
